...
int main()
{
    ...
    fseek(fp,18,SEEK_SET); //posiciona o ponteiro do ficheiro na posição 18, depois do início do ficheiro (SEEK_SET)
    ...
    fseek(fp,0,SEEK_END); //posiciona o cursor 0 posições depois do fim do ficheiro (SEEK_END)
    tam = ftell(fp); //calcula quantos caracteres/bytes tem o ficheiro
