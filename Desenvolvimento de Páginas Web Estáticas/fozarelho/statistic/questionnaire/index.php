...
<!--
    ...
    Foz do Arelho
    statistic/questionnaire/index.php
...
<html>
    <head>
        ...
        <script>
            ...
            <title> Questionnaire - Foz do Arelho </title>
        ...
        <header>
            <div class="title_header">
                ...
                <nav class="menu">
                    ...
                    <a class="menu_items" href="../../estatistica/questionario"> PT </a>
                </nav>
            </div>
        </header>
        <section>
            ...
            ?>
            <form class="form" method="post" action="respond_questionnaire.php">
